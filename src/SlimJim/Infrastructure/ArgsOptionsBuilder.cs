			...
			optionSet = new OptionSet
							{
								...
								{ "c|convert", "convert assembly references in proj files to project references", 
								...
								{ "H|fixhintpaths", "convert hint paths in proj files to point to nuget packages folder relative to generated sln",
									v => options.FixHintPaths = true },
								{ "U|restorehintpaths", "unconvert hint paths in proj files to point to their original nuget packages folder",
